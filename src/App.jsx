...
const EFFECT_STYLE_CSS = `
  ...
  .effect-surface .commerce-stage:before{content:"";position:absolute;inset:0 -8% -190px;z-index:-2;background-image:var(--fx-stage-image),radial-gradient(circle at 18% 12%,rgba(215,25,32,.2),transparent 28%),radial-gradient(circle at 78% 18%,rgba(8,116,67,.22),transparent 34%),linear-gradient(120deg,rgba(255,255,255,.9),rgba(244,245,247,.38) 42%,rgba(255,255,255,.72));background-repeat:no-repeat,no-repeat,no-repeat,no-repeat;background-size:min(1860px,112vw) auto,120% 120%,120% 120%,100% 100%;background-position:right -150px top -148px,0% 0%,100% 0%,center;filter:blur(var(--fx-stage-blur));opacity:calc(var(--fx-enabled) * var(--fx-stage-opacity));transform:scale(1.01);animation:fx-stage-drift calc(var(--fx-speed) * 2.2) ease-in-out infinite}
  .effect-surface .commerce-stage:after{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(90deg,rgba(255,255,255,.9) 0%,rgba(255,255,255,.68) 28%,rgba(255,255,255,.28) 58%,rgba(255,255,255,.62) 100%),linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.44) 40%,rgba(244,245,247,.84) 100%),linear-gradient(115deg,transparent 0 44%,rgba(215,25,32,.08) 44% 45%,transparent 45% 100%),linear-gradient(245deg,transparent 0 56%,rgba(8,116,67,.08) 56% 57%,transparent 57% 100%);pointer-events:none}
  .effect-surface .premium-hero{overflow:hidden;margin-top:18px;margin-bottom:20px;padding-top:28px;padding-bottom:30px;border-radius:18px;background-image:linear-gradient(90deg,rgba(8,10,12,.86),rgba(21,4,6,.7) 48%,rgba(3,36,23,.62)),var(--fx-stage-image);background-repeat:no-repeat;background-size:min(1780px,124vw) auto;background-position:right -170px top -260px;box-shadow:0 24px 70px rgba(12,14,18,.18),inset 0 0 0 1px rgba(255,255,255,.12)}
  ...
  @keyframes fx-stage-drift{0%,100%{background-position:right -150px top -148px,0% 0%,100% 0%,center}50%{background-position:right -96px top -118px,10% 6%,90% 10%,center}}
  ...
  @media(max-width:560px){.effect-surface .topbar:before{display:none}.effect-surface .commerce-stage{padding-bottom:20px}.effect-surface .commerce-stage:before{inset:0 -52% -120px;background-size:1050px auto,120% 120%,120% 120%,100% 100%;background-position:center top -54px,0% 0%,100% 0%,center;opacity:calc(var(--fx-enabled) * var(--fx-stage-opacity) * .86)}.effect-surface .commerce-stage:after{background:linear-gradient(90deg,rgba(255,255,255,.88),rgba(255,255,255,.42),rgba(255,255,255,.8)),linear-gradient(180deg,rgba(255,255,255,.1),rgba(255,255,255,.62) 46%,rgba(244,245,247,.9) 100%)}.effect-surface .premium-hero{margin-top:12px;margin-bottom:16px;padding-top:16px;padding-bottom:18px;border-radius:14px;background-size:1180px auto;background-position:center top -150px}.effect-surface .site-header:before{background:linear-gradient(120deg,rgba(215,25,32,.05),transparent)}}
`;
